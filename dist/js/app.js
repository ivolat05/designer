...
$(function () {
	let mainImg = {
		'main-0': {
			...
			'name': 'Клиент Дмитрий',
			'btn': '',
			'text': 'Мне необходимо креативно оформить информацию о кофейне. Мы открылись совсем недавно, но посетителей совсем мало. А мы готовим вкусный кофе и предлагаем большой выбор десертов. ',
			'box': ''
		},
		'main-1': {
			'nameClass': 'designer',
			'name': 'Дизайнер студии «Дизайн будущего»',
			'btn': `
			<button class="designer-btn">
							?
						</button>
			`,
			'text': 'Поняла вас. Могу предложить …',
			'box': `
			<div class="designer-box">
						<button class="dessinger-box-btn" data-size="color" data-compare="color" data-counter="4">
							<span>
								оформить большой плакат для наружной рекламы.
							</span>
						</button>
						<button class="dessinger-box-btn" data-size="color" data-compare="color-error" data-counter="2">
							<span>
								прорекламировать кофейню на большом билборде на одной из улиц нашего города.
							</span>
						</button>
						<button class="dessinger-box-btn" data-size="color" data-compare="color-error-2" data-counter="2">
							<span>
								оформить визитку
							</span>
						</button>
		...
		'color-0': {
			...
			'name': 'Клиент Дмитрий',
			'btn': '',
			'text': 'Да, тоже думал о плакате для наружной рекламы. Например, на большое окно кофейни.',
			'box': ''
		},
		'color-1': {
			'nameClass': 'designer',
			'name': 'Дизайнер студии «Дизайн будущего»',
			'btn': ` `,
			'text': 'Хорошо. Какие будут пожелания к плакату? Какую информацию хотите разместить? ',
			'box': ``
		},
		'color-2': {
			'nameClass': 'visitor',
			'name': 'Клиент Дмитрий',
			'btn': '',
			'text': `Думаю, что необходимо название нашей кофейни и <br> какой-нибудь запоминающийся заголовок.  `,
			'box': ''
		},
		'color-3': {
			'nameClass': 'designer',
			...
			`,
			'text': 'Хорошо. Есть какие-то пожелания по …',
			'box': `
			<div class="designer-box">
						<button class="dessinger-box-btn" data-size="soothing" data-compare="soothing-error" data-counter="4">
							<span>
							плотности бумаги?
							</span>
						</button>
						<button class="dessinger-box-btn" data-size="soothing" data-compare="soothing" data-counter="4">
							<span>
							цвету, оттенкам?
							</span>
						</button>
		...
		'soothing-0': {
			...
			'name': 'Клиент Дмитрий',
			'btn': '',
			'text': 'Да, хочется видеть плакат спокойных цветов без ярких элементов. В нашем интерьере преобладают «кофейные» цвета, хочется сохранить этот стиль.',
			'box': ''
		},
		'soothing-1': {
			'nameClass': 'designer',
			'name': 'Дизайнер студии «Дизайн будущего»',
			'btn': ` `,
			'text': 'А есть какие-то пожелания по изображениям на <br> плакате?',
			'box': ``
		},
		'soothing-2': {
			'nameClass': 'visitor',
			'name': 'Клиент Дмитрий',
			'btn': '',
			'text': `Главное — это наш логотип, я его вышлю. А остальное — на ваше усмотрение.`,
			'box': ''
		},
		'soothing-3': {
			'nameClass': 'designer',
			...
			`,
			'text': 'Хорошо, я поняла.',
			'box': `
			<div class="designer-box">
						<button class="dessinger-box-btn" data-size="harmonization" data-compare="harmonization" data-counter="2">
							<span>
		...
		'harmonization-0': {
			...
			'name': 'Клиент Дмитрий',
			'btn': '',
			'text': `Отлично! Вы же сможете напечатать? `,
			'box': ''
		},
		'harmonization-1': {
			'nameClass': 'designer',
			...
			`,
			'text': 'Напечатать плакат? …',
			'box': `
			<div class="designer-box">
						<button class="dessinger-box-btn" data-size="circulation" data-compare="circulation" data-counter="4">
							<span>
							Да, конечно. После согласования мы отправим макет в типографию на печать.
							</span>
						</button>
						<button class="dessinger-box-btn" data-size="circulation" data-compare="circulation-error" data-counter="4">
							<span>
							Нет, мы же делаем дизайн, а печатать надо
в типографии
							</span>
						</button>
					</div>
		...
		'circulation-1': {
			...
			'name': 'Дизайнер студии «Дизайн будущего»',
			'btn': ` `,
			'text': ' Какой формат будем изготавливать?',
			'box': ``
		},
		'circulation-2': {
			'nameClass': 'visitor',
			'name': 'Клиент Дмитрий',
			'btn': '',
			'text': `Нужен большой плакат, чтобы привлечь внимание прохожих.`,
			'box': ''
		},
		'circulation-3': {
			'nameClass': 'designer',
			...
			`,
			'text': 'Лучшим решением будет формат А1. Осталось уточнить еще пару моментов. Это … ',
			'box': `
			<div class="designer-box">
						<button class="dessinger-box-btn" data-size="price" data-compare="price-error" data-counter="2">
							<span>
							цветовая модель для печати. Как думаете, лучше RGB или CMYK?
							</span>
						</button>
						<button class="dessinger-box-btn" data-size="price" data-compare="price" data-counter="2">
							<span>
							тираж и сроки. Сколько копий плаката необходимо и в какие сроки изготовить?
							</span>
						</button>
					</div>
			`
		...
		'price-0': {
			...
			'name': 'Клиент Дмитрий',
			'btn': '',
			'text': `Нам надо пять плакатов, а по срокам… Надо быстро. Открытие уже состоялось, а гостей еще мало. Хотелось бы получить плакаты уже послезавтра. `,
			'box': ''
		},
		'price-1': {
			'nameClass': 'designer',
			...
			`,
			'text': 'Да, сроки сжатые. …',
			'box': `
			<div class="designer-box">
						<button class="dessinger-box-btn" data-size="briefing" data-compare="briefing-error" data-counter="2">
							<span>
							Нет, мы так не сможем. До свидания!
							</span>
						</button>
						<button class="dessinger-box-btn" data-size="briefing" data-compare="briefing" data-counter="2">
							<span>
							Хорошо, мы готовы выполнить срочный заказ, но стоимость работ будет дороже на 20%.
в типографии
							</span>
						</button>
					</div>
		...
		'briefing-1': {
			...
			'box': `
			<div class="designer-box">
						<button class="dessinger-box-btn" data-size="briefing-final" data-compare="briefing-final-error" data-counter="2">
							<span>
							я сделаю макет и направлю его в типографию
на печать.
							</span>
						</button>
						<button class="dessinger-box-btn" data-size="briefing-final" data-compare="briefing-final" data-counter="2">
							<span>
							я сделаю макет и пришлю Вам для согласования к завтрашнему утру.
							</span>
						</button>
					</div>
			`
	...
	let listError = {
		"color-error": {
			"title": "Для небольшого бизнеса реклама на билборде пока нецелесообразна.",
			"text": 'Если запутались в действиях, загляните в справочник. ',
		},
		"color-error-2": {
			"title": "Визитка больше подходит для контактных данных человека.",
			"text": 'Если запутались в действиях, загляните в справочник.',
		},
		"soothing-error": {
			"title": "Сначала уточните пожелания по оформлению плаката. ",
			"text": 'Если запутались в действиях, загляните в справочник. ',
		},

		"circulation-error": {
			"title": "Предложите полный перечень услуг, иначе заказчик может найти другого дизайнера.",
			"text": 'Если запутались в действиях, загляните в справочник. ',
		},
		"price-error": {
			"title": "Технические требования печати – это работа дизайнера. ",
			"text": ' Если запутались в действиях, загляните в справочник. ',
		},
		"briefing-error": {
			"title": "Хорошая дизайн-студия должны быть готова к срочным заказам. ",
			"text": 'Если запутались в действиях, загляните в справочник. ',
		},
		"briefing-final-error": {
	...
	function opacityNone() {
		let itemClass = document.querySelectorAll('.main-visible');
		let counter = 0;
		...
		function stepItem() {
			...
			itemClass[counter - 1].classList.remove('main-visible')
		}
	...
	function diologRadios() {
		let chat = document.querySelector('.main-container');
	...
	// вызов диалога
	function dialogCall() {
		let btn = document.querySelectorAll('.dessinger-box-btn');
		let mainContainer = document.querySelector('.main-container');
		btn.forEach(item => {
			item.addEventListener('click', () => {
				let dataCounter = item.getAttribute('data-counter');
				let dataSize = item.getAttribute('data-size');
				let dataCompare = item.getAttribute('data-compare');
				if (dataSize === dataCompare) {
					if (dataSize == 'color') {
						let contentText = document.querySelector(`.main-${dataSize}`);
						contentText.innerHTML = 'оформить рекламный плакат';
					} else if (dataSize == 'harmonization') {
						let contentText = document.querySelector(`.main-${dataSize}`);
						contentText.innerHTML = 'спокойные цвета без ярких элементов';
					} else if (dataSize == 'price') {
						let contentText = document.querySelector(`.main-${dataSize}`);
						contentText.innerHTML = 'А1';
					} else if (dataSize == 'briefing') {
						let contentText = document.querySelector(`.main-${dataSize}`);
						contentText.innerHTML = '2 дня';
					}
					if (dataSize != 'briefing-final') {
						deletStatError()
						mainContainer.innerHTML = '';
						for (let i = 0; i < dataCounter; i++) {
							let element = document.createElement("div");

							element.classList.add('main-visible');
							element.classList.add(mainImg[`${dataSize}-${i}`]['nameClass']);
							element.innerHTML = `
					<div class="${mainImg[`${dataSize}-${i}`]['nameClass']}-head">
						<div class="${mainImg[`${dataSize}-${i}`]['nameClass']}-name">
							${mainImg[`${dataSize}-${i}`]['name']}
						</div>
						${mainImg[`${dataSize}-${i}`]['btn']}
					</div>
					<div class="${mainImg[`${dataSize}-${i}`]['nameClass']}-text">
					${mainImg[`${dataSize}-${i}`]['text']}
					</div>
					${mainImg[`${dataSize}-${i}`]['box']}
					`
						...
						dialogCall();
						diologRadios();
					} else if (dataSize == 'briefing-final') {
	...
	function explanations() {
		let btn = document.querySelectorAll('.designer-btn');
		btn.forEach(item => {
			item.addEventListener('click', () => {
				let mainWrappBox = document.querySelector('.main-error-box');
				let element = document.createElement("div");

				element.classList.add('push-window');
				element.innerHTML = `

				<img src="./img/push/push-alert.svg" alt="" class="window-img">
				...
				mainWrappBox.appendChild(element);
				setTimeout(() => {
					let pushWindow = document.querySelectorAll('.push-window')
					pushWindow.forEach(i => {
						i.remove();
					})
				}, 3000)
			})
	...
	function activeBlock() {
		...
		modalBtn.forEach(item => {
			item.addEventListener('click', () => {
				...
				let dataArr = item.getAttribute('data-part');
				let id = document.getElementById(dataArr);

				modalWrapper.forEach(i => {
